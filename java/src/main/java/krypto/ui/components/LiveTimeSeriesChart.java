...
public class LiveTimeSeriesChart extends ApplicationFrame {
  ...
  public LiveTimeSeriesChart(
      JPanel panel, String chartTitle, String seriesTitle, String xTitle, String yTitle) {
    super(chartTitle);
  ...
  private JFreeChart createChart(
      final XYDataset dataset, String chartTitle, String xTitle, String yTitle) {
