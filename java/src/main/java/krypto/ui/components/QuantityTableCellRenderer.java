...
public class QuantityTableCellRenderer extends DefaultTableCellRenderer
{
	...
	private Color backgroundColorPositive;
	private Color backgroundColorNegative;
	private Color elseBackgroundColor;
	private int column;
	private boolean alignCenter;

	public QuantityTableCellRenderer(Color foregroundColor, Color elseBackgroundColor,
			Color foregroundColorPositive, Color foregroundColorNegative, int column,
			boolean alignCenter)
	{
		super();
