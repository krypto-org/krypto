...
public final class InstrumentCacheRefreshRequest extends Table {
  ...
  public static void startInstrumentCacheRefreshRequest(FlatBufferBuilder builder) { builder.startObject(0); }
  public static int endInstrumentCacheRefreshRequest(FlatBufferBuilder builder) {
