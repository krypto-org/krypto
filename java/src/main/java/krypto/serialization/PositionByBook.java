...
public final class PositionByBook extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_1_12_0(); }
  public static PositionByBook getRootAsPositionByBook(ByteBuffer _bb) { return getRootAsPositionByBook(_bb, new PositionByBook()); }
  public static PositionByBook getRootAsPositionByBook(ByteBuffer _bb, PositionByBook obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public PositionByBook __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createPositionByBook(FlatBufferBuilder builder,
      int bookOffset,
      int positionsOffset) {
    builder.startTable(2);
    PositionByBook.addPositions(builder, positionsOffset);
    PositionByBook.addBook(builder, bookOffset);
    return PositionByBook.endPositionByBook(builder);
  }

  public static void startPositionByBook(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static int endPositionByBook(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public PositionByBook get(int j) { return get(new PositionByBook(), j); }
    public PositionByBook get(PositionByBook obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
