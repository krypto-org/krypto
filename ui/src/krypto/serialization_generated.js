 ...
 * @constructor
 */
krypto.serialization.InstrumentCacheRefreshRequest = function() {
  /**
   * @type {flatbuffers.ByteBuffer}
   */
  this.bb = null;
 ...
 * @param {number} i
 * @param {flatbuffers.ByteBuffer} bb
 * @returns {krypto.serialization.InstrumentCacheRefreshRequest}
 */
krypto.serialization.InstrumentCacheRefreshRequest.prototype.__init = function(i, bb) {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param {flatbuffers.ByteBuffer} bb
 * @param {krypto.serialization.InstrumentCacheRefreshRequest=} obj
 * @returns {krypto.serialization.InstrumentCacheRefreshRequest}
 */
krypto.serialization.InstrumentCacheRefreshRequest.getRootAsInstrumentCacheRefreshRequest = function(bb, obj) {
  return (obj || new krypto.serialization.InstrumentCacheRefreshRequest).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};

/**
 * @param {flatbuffers.Builder} builder
 */
krypto.serialization.InstrumentCacheRefreshRequest.startInstrumentCacheRefreshRequest = function(builder) {
 ...
 * @returns {flatbuffers.Offset}
 */
krypto.serialization.InstrumentCacheRefreshRequest.endInstrumentCacheRefreshRequest = function(builder) {
  var offset = builder.endObject();
  return offset;
};
